...
class Build_strings extends Helper_functions
{
  ...
  /** Will hold the result of each output method. */
    ...
    * @return                 the newly created String that is now center-justified
    */
   public String println_center_justified(boolean borders, int expected_size, String... messages)
   {
   
      return print_center_justified(borders, expected_size, messages).concat("\n");
   }
    ...
    * @return                 the newly created String that is now center-justified with borders
    */
   public String println_center_justified(int expected_size, String... messages)
   {
      
      return println_center_justified(true, expected_size, messages);
    ...
    * @return                 the newly created String that is now left-justified
    */
   public String println_left_justified(boolean borders, int expected_size, String... messages)
   {
         
      return print_left_justified(borders, expected_size, messages).concat("\n");
    ...
    * @return                 the newly created String that is now left-justified with borders
    */
   public String println_left_justified(int expected_size, String... messages)
   {
   
      return println_left_justified(true, expected_size, messages);
    ...
    * @return                 the newly created String that is now right-justified
    */
   public String println_right_justified(boolean borders, int expected_size, String... messages)
   {
         
      return print_right_justified(borders, expected_size, messages).concat("\n");
    ...
    * @return                 the newly created String that is now right-justified with borders
    */
   public String println_right_justified(int expected_size, String... messages)
   {
         
      return println_right_justified(true, expected_size, messages);
